  ...
  public boolean handle(final ObjectDescription d, final ObjectDescriptionInner i) {
    boolean _xblockexpression = false;
    {
      if ((i instanceof ObjectNode)) {
        ...
        _builder_2.newLine();
        _builder_2.append("\t");
        _builder_2.append("int nextVisit = System.identityHashCode(next);");
        _builder_2.newLine();
        _builder_2.append("\t");
        _builder_2.append("if (this.visited.contains(nextVisit))");
        _builder_2.newLine();
        _builder_2.append("\t");
        _builder_2.append("{");
        _builder_2.newLine();
        ...
        _builder_2.newLine();
        _builder_2.append("\t\t");
        _builder_2.append("this.visited.add(nextVisit);");
        _builder_2.newLine();
        _builder_2.append("\t");
        _builder_2.append("}");
        _builder_2.newLine();
