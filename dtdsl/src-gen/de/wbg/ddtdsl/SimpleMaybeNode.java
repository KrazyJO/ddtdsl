...
{
	throw new ParserException("Error while parsing next in de.wbg.dTDSL.impl.ObjectNodeImpl@7c1ee007 (attributes: next)");
}
catch (ParserException e)
{
	throw e;
	...
	public void parseNextAttributeI(Object o, Element n) throws Exception
	{
		...
		{
			n.setAttributeNumber(oldAttributeNumber);
			throw new ParserException("could not find field \"i\" in Next");
		}
		catch ( SecurityException | IllegalArgumentException | IllegalAccessException | NullPointerException e)
		{
			//e.printStackTrace();
	...
	public void parseNextAttributeS(Object o, Element n) throws Exception
	{
		...
		{
			n.setAttributeNumber(oldAttributeNumber);
			throw new ParserException("could not find field \"s\" in Next");
		}
		catch ( SecurityException | IllegalArgumentException | IllegalAccessException | NullPointerException e)
		{
			//e.printStackTrace();
