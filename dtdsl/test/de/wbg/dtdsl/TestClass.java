...
public class TestClass {
	...
	public void test() {
		...
		Attribute childOfChildOfO = (Attribute)childOfO.getChildren().get(0); //value
		
//		assertTrue("head shouldnt be a key", !o.getType());
		...
		assertTrue("childOfChildOfO: should be \"value\", but is ", childOfChildOfO.getType().equals("value"));
	...
	public void testSimpleNext()
	{
		...
		Attribute childOfNext = (Attribute)next.getChildren().get(0);
